    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ownership', models.CharField(choices=[('Indiviual', 'Indiviual'), ('JOINT', 'JOINT')], max_length=20)),
                ...
                ('Category', models.CharField(choices=[('Residential', 'Residential'), ('Commercial', 'Commercial')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Status',
